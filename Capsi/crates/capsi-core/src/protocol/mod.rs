...
pub use message::{DeliveryReceipt, Envelope, FileOffer, FileReceipt, Message, TextMessage, Typing, WorkplaceBroadcastMessage, WorkplaceSyncMessage, WorkplaceTextMessage};